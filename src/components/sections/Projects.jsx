        ...
        {projects.map((project) => (
          ...
          >
            <a
              ...
              target="_blank"
              className="image block aspect-video flex-1"
            >
              <img
            ...
            <div className="flex-2 flex flex-col gap-y-3 p-4">
              <div className="body">
                <h3 className="text-lg font-bold text-blax-950 dark:text-blax-100">{project.name}</h3>
                <p className="card-description text-blax-700 dark:text-blax-300">{project.description}</p>
              </div>
              <div className="mt-auto">
                <div className="card-stacks flex flex-wrap items-end gap-2 md:h-16">
                  {project.stacks.map((stack) => (
                    <span
                      key={stack}
                      className="rounded-md bg-blax-100 p-1 text-sm text-blax-950 dark:bg-blax-950 dark:text-blax-100"
                    >
                      {stack}
                    </span>
                  ))}
                ...
                <div className="action mt-4 flex items-center gap-x-3">
                  <a
                    ...
                    href={project.link.github || "https://github.com/abdigunasetiawan"}
                    target="_blank"
                  >
                    <svg
                      width="24"
                    ...
                    >
                      <g id="github">
                        <g id="github_2">
                          <path
                            className="fill-[#161614] dark:fill-blax-100"
                            id="Vector"
